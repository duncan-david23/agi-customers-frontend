...
const Sidebar = () => {
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 10.5H21A7.5 7.5 0 0 0 13.5 3v7.5Z" />
        ...
        { name: 'Tasks', path: '/tasks', icon:<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-5">
    ...
    <>
      ...
      `}>
        ...
        {/* Logout Button */}
          ...
          <div onClick={handleSignOut} className='flex items-center gap-2.5 absolute bottom-5 border border-gray-300 py-1.5 px-4 rounded-md cursor-pointer hover:scale-105 transition-all hover:bg-gray-300 mb-[100px]'>
