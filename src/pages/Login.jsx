        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Sign in to your ASOS Global account</p>
            </div>
          ...
          >
            ...
            <div className="bg-gradient-to-br from-gray-900 to-black rounded-3xl p-8 text-white shadow-2xl">
              <h2 className="text-3xl font-bold mb-4">
                Welcome to <span className="bg-gradient-to-r from-gray-100 to-gray-300 bg-clip-text text-transparent">ASOS Global</span>
              </h2>
              <p className="text-xl text-gray-300 mb-6">
                Continue your investment journey with one of the world's leading fashion investment platforms
              </p>
